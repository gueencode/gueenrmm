              ...
              <q-tab-panels v-model="tab" animated transition-prev="jump-up" transition-next="jump-up">
                ...
                <q-tab-panel name="general">
                  <q-card-section class="row">
                    ...
                    <div class="col-2"></div>
                    <gueen-dropdown class="col-8" v-model="agent.site" :options="siteOptions" outlined mapOptions />
                  </q-card-section>
                  <q-card-section class="row">
...
import gueenDropdown from "@/components/ui/gueenDropdown";

export default {
  name: "EditAgent",
  emits: [...useDialogPluginComponent.emits],
  components: { PatchPolicyForm, CustomField, gueenDropdown },
  mixins: [mixins],
  props: {
    agent_id: !String,
  },
