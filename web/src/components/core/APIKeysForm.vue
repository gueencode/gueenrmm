  ...
  <q-dialog ref="dialogRef" @hide="onDialogHide">
    <q-card class="q-dialog-plugin" style="width: 60vw">
      ...
      <q-form @submit.prevent="submitForm">
        ...
        <!-- user -->
        <q-card-section>
          <gueen-dropdown outlined v-model="localKey.user" label="User" :options="userOptions" mapOptions />
        </q-card-section>
...
import gueenDropdown from "@/components/ui/gueenDropdown.vue";

export default {
  components: { gueenDropdown },
  name: "APIKeysForm",
