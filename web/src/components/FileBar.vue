...
export default {
  ...
  methods: {
    openHelp(mode) {
      ...
      switch (mode) {
        case "github":
          url = "https://github.com/gueencode/gueenrmm/";
          break;
        case "docs":
          url = "https://gueencode.github.io/gueenrmm/";
          break;
        case "bug":
          url = "https://github.com/gueencode/gueenrmm/issues/new?template=bug_report.md";
          break;
        case "feature":
          url = "https://github.com/gueencode/gueenrmm/issues/new?template=feature_request.md";
          break;
        case "discord":
