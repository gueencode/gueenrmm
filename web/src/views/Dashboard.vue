  ...
  <q-layout view="hHh lpR fFf">
    <q-header elevated class="bg-grey-9 text-white">
      ...
      <q-toolbar>
        ...
        <q-toolbar-title>
          Gueen RMM<span class="text-overline q-ml-sm">v{{ currentgrmmVersion }}</span>
          <span
            class="text-overline q-ml-md"
            v-if="latestgrmmVersion !== 'error' && currentgrmmVersion !== latestgrmmVersion"
            ><q-badge color="warning"
              ><a :href="latestReleaseURL" target="_blank">v{{ latestgrmmVersion }} available</a></q-badge
            ></span
          >
        </q-toolbar-title>
...
export default {
  ...
  data() {
    return {
      ...
      currentgrmmVersion: null,
      latestgrmmVersion: "error",
  ...
  methods: {
    ...
    getDashInfo(edited = true) {
      this.$store.dispatch("getDashInfo").then(r => {
        ...
        this.currentgrmmVersion = r.data.grmm_version;
        this.latestgrmmVersion = r.data.latest_grmm_ver;
  ...
  computed: {
    ...
    latestReleaseURL() {
      return this.latestgrmmVersion !== "error"
        ? `https://github.com/gueencode/gueenrmm/releases/tag/v${this.latestgrmmVersion}`
        : "";
    },
    wsUrl() {
