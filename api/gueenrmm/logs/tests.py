...
class TestAuditViews(gueenTestCase):
    def setUp(self):
        self.authenticate()
    ...
    def test_cancel_pending_action(self, nats_cmd):
        ...
        action = baker.make(
            ...
            details={
                ...
                "taskname": "gueenrmm_SchedReboot_wYzCCDVXlc",
            },
        )
        ...
        nats_data = {
            "func": "delschedtask",
            "schedtaskpayload": {"name": "gueenrmm_SchedReboot_wYzCCDVXlc"},
        }
...
class TestLogTasks(gueenTestCase):
