...
class TestAccounts(gueenTestCase):
    def setUp(self):
        self.client_setup()
...
class TestGetAddUsers(gueenTestCase):
    def setUp(self):
        self.authenticate()
...
class GetUpdateDeleteUser(gueenTestCase):
    def setUp(self):
        self.authenticate()
        self.setup_coresettings()
...
class TestUserAction(gueenTestCase):
    def setUp(self):
        self.authenticate()
        self.setup_coresettings()
...
class TestAPIKeyViews(gueenTestCase):
    def setUp(self):
        self.setup_coresettings()
        self.authenticate()
...
class TestTOTPSetup(gueenTestCase):
    def setUp(self):
        self.authenticate()
        self.setup_coresettings()
...
class TestAPIAuthentication(gueenTestCase):
    def setUp(self):
