...
def reload_nats():
    users = [{"user": "gueenrmm", "password": settings.SECRET_KEY}]
...
def get_latest_grmm_ver() -> str:
    url = "https://raw.githubusercontent.com/gueencode/gueenrmm/master/api/gueenrmm/gueenrmm/settings.py"
    try:
