...
class TestCodeSign(gueenTestCase):
    def setUp(self):
...
class TestConsumers(gueenTestCase):
    def setUp(self):
        self.setup_coresettings()
        self.authenticate()
...
class TestCoreTasks(gueenTestCase):
    def setUp(self):
        self.setup_coresettings()
        self.authenticate()
    ...
    @patch("gueenrmm.utils.reload_nats")
...
class TestCorePermissions(gueenTestCase):
    def setUp(self):
        self.client_setup()
        self.setup_coresettings()
