...
#Optional: C:\Program Files\gueenAgent\BurntToastLogo.png will be displayed if the file exists. Image dimensions 478px (W) x 236px (H)
...
Invoke-AsCurrentUser -scriptblock {
    ...
    $heroimage = New-BTImage -Source 'C:\Program Files\gueenAgent\BurntToastLogo.png' -HeroImage
